...
static const uint16_t iso8859_7_t_0[] = {
  0x00a0, 0x2018, 0x2019, 0x00a3, 0x0000, 0x0000, 0x00a6, 0x00a7, 0x00a8, 0x00a9, 0x0000, 0x00ab,
  0x00ac, 0x00ad, 0x0000, 0x2015, 0x00b0, 0x00b1, 0x00b2, 0x00b3, 0x0384, 0x0385, 0x0386, 0x00b7,
  ...
  0x03c4, 0x03c5, 0x03c6, 0x03c7, 0x03c8, 0x03c9, 0x03ca, 0x03cb, 0x03cc, 0x03cd, 0x03ce
};
...
struct rxvt_codeset_conv_iso8859_7 : rxvt_codeset_conv {
  ...
  uint32_t to_unicode (uint32_t enc) const {
    ...
    if (0x00a0 <= enc && enc <= 0x00fe)
      return iso8859_7_t_0[enc - 0x00a0] == 0 ? NOCHAR : iso8859_7_t_0[enc - 0x00a0];
    return NOCHAR;
  }
