...
C<selection-popup> and C<readline> extensions, any extensions that define
keybindings via C<BINDING> meta comments, extensions loaded because
their resources/commandline switches were used, and extensions which are
mentioned in B<keysym> resources.
